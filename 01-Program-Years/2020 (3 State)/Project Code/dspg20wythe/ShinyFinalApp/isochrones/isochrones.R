...
# 
# #write.csv(va_sf, file = "va_sf")
# #va_sf <- read_csv("va_sf")
# 
...
#write.csv(map_and_data, file = "map_data")
# write.csv(Wythe_area_outline, file ="wythe_area_outline")
# write.csv(Wythe_outline, file = "wythe_outline")
# write.csv(pop_centroid_wythe_iso_60, file = "pop_centroid_wythe_iso_60")
# write.csv(centerPop_wythe, file = "centerPop_wythe")
# write.csv(nearby_airport, file = "nearby_airport")
# write.csv(filtered_college_university, file = "filtered_college_university")
# write.csv(workforce_dev_center_data, file = "workforce_dev_center_data")
# write.csv(filtered_hospitals, file = "filtered_hospitals")

# map_and_data <- map_and_data[,-1]
# map_and_data <- as.numeric(map_and_data)
