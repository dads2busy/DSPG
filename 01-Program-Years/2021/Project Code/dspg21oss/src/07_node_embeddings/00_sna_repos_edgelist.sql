CREATE MATERIALIZED VIEW gh_2007_2020.commits_per_user_157k AS (
...
WITH C AS (
	...
	inner join gh_2007_2020.repos_subset_157k B
	on a.slug = b.slug
...
CREATE MATERIALIZED VIEW gh_2007_2020.sna_repos_157k_edges AS (
...
WITH F AS (
	...
	FROM gh_2007_2020.commits_per_user_157k D
	INNER JOIN gh_2007_2020.commits_per_user_157k AS E 
...
CREATE INDEX sna_repos_157k_edges_slug1_idx ON gh_2007_2020.sna_repos_157k_edges (slug1);
CREATE INDEX sna_repos_157k_edges_slug2_idx ON gh_2007_2020.sna_repos_157k_edges (slug2);
